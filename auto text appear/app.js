...
const career = ["singer", "dancer", "flutist", "typist", "racist", "instructor"];
...
function updateText(){
    ...
    container.innerHTML = `<h1>Iam ${career[careerIndex].slice(0,1)=== "i"? "an":"a"} ${career[careerIndex].slice(0,characterIndex)}</h1>` //slice give us substring of a string 1st argument will be index position 2nd will be no of char that we wnt to print
